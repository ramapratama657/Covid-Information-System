...
<div id="wrapper" class="d-flex">
    ...
    <div class=" border-right" id="sidebar-wrapper">
        <div class="sidebar-heading text-center">Welcome Rama</div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                          <div class="card bg-blue">
                            <div class="card-body">
                             <h5 class="card-title"><i class="fa fa-hospital-o "></i> Manage Test Centre</h5>
                              <p class="card-text text-secondary">For record and display list of Test Centre.</p>
                              <a href="testcentre.php" class="btn btn-primary">Go to</a>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-4">
                          <div class="card bg-blue">
                            <div class="card-body">
                              <h5 class="card-title"><i class="fa fa-user"></i> Manage Tester</h5>
                              <p class="card-text text-secondary">For record and display list of Tester.</p>
                              <a href="manage_tester.php" class="btn btn-primary">Go to</a>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-4">
                          <div class="card bg-blue">
                            <div class="card-body">
                              <h5 class="card-title"><i class="fa fa-medkit "></i> Manage Test Kit</h5>
                              <p class="card-text text-secondary">For record and display list of Test Kit.</p>
                              <a href="manage_kit.php" class="btn btn-primary">Go to</a>
                            </div>
                          </div>
                        </div>
                    </div>
