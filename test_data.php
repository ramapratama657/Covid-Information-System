...
<div id="wrapper" class="d-flex">
    ...
    <div class=" border-right" id="sidebar-wrapper">
        <div class="sidebar-heading text-center">Welcome Tester</div>
                ...
                <div class="card-body ">
                    ...
                    <div class="justify-content-center">
                        <div class="col-auto"> 
                            ...
                            <?php
                                include "koneksi.php";
                                $query = mysqli_query($koneksi,"SELECT * from tbpatient");
                            ...
                            ?>
                                <table class="table table-hover justify-content-center mx-auto border">
                                    ...
                                    <tbody>
                                    <tr>
                                        <th scope="row"><?php echo $data["notestreport"];?></th>
                                        <td><?php echo $data["name"];?></td>
                                        <td><?php echo $data["patienttype"];?></td>
                                        <td><?php echo $data["symptoms"];?></td>
                                        <td><?php echo $data["result"];?></td>
                                        <td><?php echo $data["status"];?></td>
                                        <td><?php echo $data["testcentreplace"];?></td>
                                        <td class="d-flex"><a href="update_test.php" class="btn btn-sm btn-primary mr-1">Update</a><a href="" class="btn btn-sm btn-danger">Delete</a></td>
                                    </tr>
                                    </tbody>
                                    <?php  
                                        $data++;}
