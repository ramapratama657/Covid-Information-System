...
CREATE TABLE `tbtester` (
  `notester` int(20) NOT NULL,
  `username` varchar(50) NOT NULL,
...
INSERT INTO `tbtester` (`notester`, `username`, `password`, `testername`, `testcentrename`) VALUES
(3, 'adnya', 'adnya', 'Adnya Utari', 'RS Bangli'),
(4, 'dika', 'dika', 'Putu Dika', 'RS Bangli'),
(5, 'satria', 'satria', 'putra satria', 'RS Denpasar'),
(6, 'satria', 'satria', 'putra satria', 'RS Denpasar'),
(7, 'awoi', 'awoi', 'Shinta', 'RS Aceh'),
(9, 'wahyudi', 'wahyudi', 'Wahyudi Setiawan', 'RS Karangasem'),
(10, 'tester2', 'tester2', 'tester2', 'testaja');
