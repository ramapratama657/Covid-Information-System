        ...
        <div class="container">
            <div class="card my-5 p-3">
                <div class="card-heading ">
                    ...
                    <h2 class="card-title text-center">Register Tester</h2>
                </div>
                <div class="card-body">
                    <form action="prosesrecordtester.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="testername" placeholder="Name">
                        </div>
                        <div class="form-group">
                            <label for="testcentre">Test Centre</label>
                            <input type="text" class="form-control" name="testcentrename" placeholder="Test Centre Name">
                        </div>
