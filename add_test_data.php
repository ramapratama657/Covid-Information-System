                    ...
                    <form action="" method="">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="exampleFormControlSelect1">
                                <option value="Nyoman Astawa">Nyoman Astawa</option>
                                <option value="Nyoman Bandem">Nyoman Bandem</option>
                                <option value="Putu Adi">Putu Adi</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="name">Symptoms</label>
                            <input type="text" class="form-control" name="symptoms" aria-describedby="symptoms" placeholder="Symptoms">
                        </div>
                        <div class="form-group">
