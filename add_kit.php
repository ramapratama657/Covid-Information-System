                ...
                ?>
                    <form action="prosesrecordtestkit.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="testkitname" aria-describedby="name" placeholder="Test Kit name">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="test_centre">Test Centre</label>
                             <input type="text" class="form-control" name="testcentrename" aria-describedby="testcentrename" placeholder="Test Centre">
