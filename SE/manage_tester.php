    ...
    <div id="page-content-wrapper">
        <div class="container">
            <div class="card my-5 p-3">
                ...
                <div class="card-body ">
                    <a href="register_tester.php" class="btn btn-primary mb-4">Record new Tester</a>
                            ...
                            ?>
                                <table class="table table-hover justify-content-center mx-auto border">
                                    ...
                                    <tr>
                                        ...
                                        <th class=>Tester Name</th>
                                        <th class=>Test Centre</th>
                                        <th>Action</th>
                                    </tr>
                                    </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex"><a href="update_tester.php?id=<?=$data['id'];?>" class="btn btn-sm btn-primary mr-1">Update</a><a href="delete_data.php?id=<?=$data['id'];?>&table=tbuser" class="btn btn-sm btn-danger">Delete</a></td>
                                    </tr>
                                    <?php  
                                        endforeach;
                                    ?>
