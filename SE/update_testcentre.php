...
{
    $id = $_GET['id'];
    $query = mysqli_query($koneksi,"SELECT * FROM tbtestcentre WHERE id= $id");
        ...
        <div class="container">
            <div class="card my-5 p-3">
                <div class="card-heading ">
                    ...
                    <h2 class="card-title text-center">Update Test Centre</h2>
                </div>
                <div class="card-body">
                    <form action="updateCentre.php?id=<?=$id;?>" method="post">
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input type="text" name="testcentrename" class="form-control" value="<?=$row['testcentrename']?>" required>
                        </div>
