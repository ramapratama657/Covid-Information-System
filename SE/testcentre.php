    ...
    <div id="page-content-wrapper">
        <div class="container">
            <div class="card my-5 p-3">
                ...
                <div class="card-body ">
                    <a href="register_testcentre.php" class="btn btn-primary mb-4">Register Test Centre</a>
                    <div class="justify-content-center">
                        <div class="col-auto"> 
                            ...
                            <?php
                                include "koneksi.php";
                                $query = mysqli_query($koneksi,"SELECT * from tbtestcentre");
                            ...
                            ?>
                                <table class="table table-hover justify-content-center mx-auto border">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex"><a href="update_testcentre.php?id=<?=$data['id'];?>" class="btn btn-sm btn-primary mr-1">Update</a><a href="delete_data.php?id=<?=$data['id'];?>&table=tbtestcentre" class="btn btn-sm btn-danger">Delete</a></td>
                                    </tr>
