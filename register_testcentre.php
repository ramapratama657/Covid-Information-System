        ...
        <div class="container">
            <div class="card my-5 p-3">
                <div class="card-heading ">
                    ...
                    <h2 class="card-title text-center">Register Test Centre</h2>
                </div>
                <div class="card-body">
                    <form action="prosesrecordtestcentre.php" method="post">
                        <div class="form-group">
                            <label for="name">Test Centre Name</label>
                            <input type="text" name="testcentrename" class="form-control" id="name" placeholder="Enter test centre name">
                          </div>
                          <!-- <div class="form-group">
